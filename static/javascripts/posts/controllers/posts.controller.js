/**
* PostsController
* @namespace sidewalkeggs.posts.controllers
*/
(function () {
	'use strict';
	...
	*/
	function PostsController($scope) {
		...
		* @memberOf sidewalkeggs.posts.controllers.PostsController
		*/
		function activate() {
	    ...
	    * @memberOf sidewalkeggs.posts.controllers.PostsControllers
	    */
